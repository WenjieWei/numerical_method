...
\begin{document}
	...
	\section{Coaxial Cable Electrostatic Problem}
		...
		\subsection{Capacitance per Unit Length}
			...
			Use the Python function implemented in Listing \ref{lst:finite_element}, we are able to calculate the energy contained in a single quadrant using Equation \ref{USU}. The following calculation is performed to find the total capacitance per unit length:
			$$
